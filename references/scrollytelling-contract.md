...
- Each scene contains `.mint-scene__viewport > .mint-scene__stage`. Desktop and PDF compose the stage at 1920×1080 and scale it uniformly. Supporting details may follow the viewport. Use `scroll-snap-type:y proximity`. Phone-specific authoring and QA are not part of this Skill's standard workflow.
...
- On narrow screens the report scroll region and persistent chrome occupy separate bands. Do not move report text beneath fixed controls to recover space.
