...
const model = { schemaVersion: "0.9.4", sceneById, atoms: Object.fromEntries(map.contentAtoms.map((atom) => [atom.id, atom.text])), sourceSetHash: state.sourceSetHash, structureHash: state.structureHash };
