...
import { buildSourceLock, compileChineseSource } from "../../mint-report-deck/scripts/compile-chinese-source.mjs";
import { planDeck } from "../../mint-report-deck/scripts/plan-deck.mjs";
...
const scenes = plan.pageContracts.map((page) => {
...
const brief = {
  ...
  scenes,
  artDirection: {
    brandAnchors: ["Mint 标识", "中文优先字体层级", "Mint 核心绿色", "轻量来源样式"],
...
write("source-lock.json", { ...sourceLock, schemaVersion: "0.9" });
